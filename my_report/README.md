...
Task 2: Αρχικά μελέτησα το παραδειγμα 16-11 και 16-13 & στο 16-7 αυτό που έκανα ηταν να ορίσω ενα ορθογωνιο κιτινου χρώματας εντι της προυπάρχουσας έλλειψης. Ετρεξα το πρόγραμμα και κίνησα το χέρι μου για να δω οτι το ορθογωνιο θα ακολουθήσει αυτή την κίνηση
...
Task 4: Αλλαξα το παραδειγμα 9-8 σε συνδυασμο με το 16-5 και ορισα τοχ ρωμα σε μωβ με ενα ποσοστο διαφάνειας και με λευκό περίγραμμα
Απαντηση στην ερωτηση: 1)απαιτειται μονο η υπαρξη της καμερας 2)μπορει να γινει απο αποσταση 3) ευκολια προσβασης και τα μειονεκτηματα ηταν 1)
